window.onload = () => {
    ...
    let stripe = Stripe('pk_test_51INaYzFQ99jFDHtEckN7iiLA4giZPPFyeWltWeW2YMAB8btCJ15MP99OLaWehO0Wkld00BOZ2r5hn0sVVuZGzrLH00dZ1mYviD');

    // Initialise les éléments du formulaire
    let elements = stripe.elements();

    // Définit la redirection en cas de succès du paiement
    let redirect = "commandView.php";
